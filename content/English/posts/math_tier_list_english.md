...
**Rating:**
$$ \boxed{\text{NPC with a graphing calculator}} $$
...
**Rating:**
$$ \boxed{\text{cooked, but microwave cooked}} $$
...
**Rating:**
$$ \boxed{\text{NPC until it suddenly isn’t}} $$
...
**Rating:**
$$ \boxed{\text{major character development}} $$
...
**Rating:**
$$ \boxed{\text{geometry after taking psychedelics}} $$
...
$$ \text{conditional expectation as an } L^2 \text{ projection modulo null sets} $$
